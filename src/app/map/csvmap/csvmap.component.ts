...
export class CsvmapComponent implements OnInit {
  ...
  t = loadModules(['esri', 'esri/map', "esri/graphic", "esri/geometry/Point", "esri/layers/GraphicsLayer", "esri/dijit/HomeButton", "dojo/domReady!"], options)
    .then(([esri, Map, Graphic, Point, GraphicsLayer, HomeButton]) => {
      ...
      function addWellGraphic(x, y) {
        ...
        var wellGraphic = new Graphic(wellPnt);
